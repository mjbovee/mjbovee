			...
			<section class="contact" id="contact" >
				<div class="container-fluid text-dark p-5 ">
					<div class="row m-md-5 justify-content-center">
						...
						<form class="col-md-5 offset-md-1 p-md-3 text-center slide-in slide-in-right">
							<div class="p-2">
								<input class="contactItem" type="text" id="name" name="contact_name" placeholder="Your name">
							</div>
							<div class="p-2 ">
								<input class="contactItem" type="text" id="email" name="contact_email" placeholder="Your email">
							</div>
							<div class="p-2 ">
				...
				<div class="text-center row justify-content-center mt-5 pb-5">
